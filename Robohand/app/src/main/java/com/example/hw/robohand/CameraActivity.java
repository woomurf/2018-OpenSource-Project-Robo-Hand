...
public class CameraActivity extends AppCompatActivity {
    ...
    private static final String LOCAL_MODEL_ASSET = "graph.tflite";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRunCustomModelButton = (Button)findViewById(R.id.take_picture);
    ...
    private void runModelInference() {
        ...
        try {
            ...
            mInterpreter
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            e.printStackTrace();
                            showToast("Error running model inference1");
                        }
                    })
                    .continueWith(
            ...
            e.printStackTrace();
            showToast("Error running model inference2");
        }
